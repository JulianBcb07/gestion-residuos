...
<div class="min-h-screen p-6 bg-gray-100 flex items-center justify-center">
  <div class="container max-w-screen-lg mx-auto">
    <div>
      <h2 class="font-semibold text-xl text-gray-600">Generación Semanal en el Instituto Tecnológico de Valladolid</h2>
        ...
        <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
          ...
          <div class="lg:col-span-2">
            <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
              ...
              <div class="md:col-span-2">
                <label for="country">Adicional</label>
              ...
              <div class="md:col-span-2">
                <label for="state">Adicional 2</label>
                <div class="h-10 bg-gray-50 flex border border-gray-200 rounded items-center mt-1">
              ...
              <div class="md:col-span-1">
                <label for="zipcode">Oberservacion</label>
              ...
              <div class="md:col-span-5">
                <div class="inline-flex items-center">
                  ...
                  <label for="billing_same" class="ml-2">Confirmo que los datos son válidos.</label>
                </div>
              </div>

              <div class="md:col-span-2">
                <label for="soda">Ejemplo de contador</label>
