                            ...
                            @foreach ($registroPeriodo as $index => $registro)
                                <tr class="border-b dark:border-gray-900">
                                    ...
                                    <td class="px-4 py-3 flex items-center justify-center gap-2">
                                            <a href="{{route('gensubproductos.edit', ['instituto_id' => $registro->instituto_id, 'inicio' => $registro->fecha_inicio, 'final' => $registro->fecha_final])}}">
                                                <i class="fa-solid fa-pen-to-square"></i>
                                            </a>
                                            <a href="{{route('gensubproductos.show', ['instituto_id' => $registro->instituto_id, 'inicio' => $registro->fecha_inicio, 'final' => $registro->fecha_final])}}"><i class="fa-solid fa-eye"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
