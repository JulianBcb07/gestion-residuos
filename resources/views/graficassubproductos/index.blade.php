        ...
        <div class="flex justify-between items-center">
            ...
            <div class="flex gap-4 items-center">
                ...
                <div id="dateRangeDropdown"
                    class="z-10 hidden bg-blue-900 divide-y divide-gray-100 rounded-lg shadow w-80 lg:w-96 dark:bg-gray-700 dark:divide-gray-600">
            ...
            <div class="max-w-8xl w-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6 col-span-2 row-span-2">
                <div class="flex justify-between items-start w-full">
                    ...
                    <div class="flex justify-end items-center">
                        <button id="widgetDropdownButton1" data-dropdown-toggle="widgetDropdown1"
                        ...
                        <div id="widgetDropdown1"
                            class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                            <ul class="py-2 text-sm text-gray-700 dark:text-gray-200"
                                aria-labelledby="widgetDropdownButton1">
                                <li>
                                    <a href="#"
